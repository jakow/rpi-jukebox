...
if __name__  == '__main__':
    ...
    mp = MPlayer()
    mp.loadfile("/home/jakub/Programming/PycharmProjects/flask-fm/songs/01. Release Your Problems.mp3")
    sleep(5)
    mp.set_property('volume', 100.0)
    sleep(5)
    mp.pause()
    filename = mp.get_property('filename')
    print filename #[filename.find("ANS_filename")+1+len("ANS_filename"):]
    mp.stop()
